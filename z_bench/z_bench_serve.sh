...
TP=1
DP=2
MAX_MODEL_LEN=292000 
OUTPUT_LEN=128 
RESULTS_FILE="benchmark_serve_1tp_1sp_2dp_sharegpt_2gpus.csv" 
OUTPUT_FILE="benchmark_serve_1tp_1sp_2dp_sharegpt_2gpus.txt" 
...
input_len_list=(1000)
request_rate_list=(1 2 4 8 16 32)
    ...
    for input_len in "${input_len_list[@]}"; do
        for request_rate in "${request_rate_list[@]}"; do
            ...
            output=$(vllm bench serve \
                ...
                --dataset-path "/nfs/stak/users/gaosho/hpc-share/projects/data/ShareGPT_V3_unfiltered_cleaned_split.json" \
