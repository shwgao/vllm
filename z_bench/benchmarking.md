...
vllm serve meta-llama/Meta-Llama-3-70B-Instruct --disable-log-requests --data-parallel-size 2 --tensor-parallel-size 1 --pipeline-parallel-size 1 --max-model-len 5000 --enforce-eager --gpu-memory-utilization 0.8 --max-num-batched-tokens 8192 --no-enable-prefix-caching --max_num_seqs 10 --block-size 16 --port 8009 --quantization "fp8"
